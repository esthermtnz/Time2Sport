...
class SearchResultsViewTestCase(TestCase):
    ...
    def test_redirect_for_unauthenticated_users(self):
        ...
        self.assertRedirects(
            response, f"/accounts/login/?next={reverse('search_results')}")
    ...
    def test_search_results_view_1(self):
        ...
        response = self.client.post(reverse('search_results'), {
                                    'q': self.activity.name, 'category': self.activity.activity_type})
    ...
    def test_search_results_view_2(self):
        ...
        response = self.client.post(reverse('search_results'), {
                                    'q': self.sport_facility.name, 'category': self.sport_facility.facility_type})
    ...
    def test_search_with_extra_spaces(self):
        ...
        response = self.client.post(
            reverse('search_results'), {'q': "  Zumba  "})
